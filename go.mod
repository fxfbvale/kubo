...
replace (
	...
	github.com/ipfs/go-namesys v0.7.0 => github.com/fxfbvale/go-namesys latest
	//github.com/libp2p/go-libp2p-kad-dht v0.21.1 => ../../Kademlia-DHT/go-libp2p-kad-dht
	github.com/libp2p/go-libp2p-kad-dht v0.21.1 => github.com/fxfbvale/go-libp2p-kad-dht latest
)
